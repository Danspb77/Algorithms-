...
// prev - указатель на предыдущий элемент списка. Область определения: -2,147,483,648 .. 2,147,483,647
// tail - указатель на последний элемент списка. Область определения: -2,147,483,648 .. 2,147,483,647
// queue - указатель на структуру кольцевой очереди. Область определения: -2,147,483,648 .. 2,147,483,647
// file - указатель на файловую переменную. Область определения: -2,147,483,648 .. 2,147,483,647
// current - указатель на текущий элемент списка. Область определения: -2,147,483,648 .. 2,147,483,647
// rightQueue - указатель на структуру кольцевой очереди. Область определения: -2,147,483,648 .. 2,147,483,647
// leftQueue - указатель на структуру кольцевой очереди. Область определения: -2,147,483,648 .. 2,147,483,647
// head - указатель на первый элемент списка. Область определения: -2,147,483,648 .. 2,147,483,647
// next - указатель на следующий элемент списка. Область определения: -2,147,483,648 .. 2,147,483,647
// front - указатель на первый элемент кольцевой очереди. Область определения: -2,147,483,648 .. 2,147,483,647
// rear - указатель на последний элемент кольцевой очереди. Область определения: -2,147,483,648 .. 2,147,483,647
